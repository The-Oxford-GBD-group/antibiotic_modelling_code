...
#' @param check_pixelcount boolean, do a check for covariates with too few pixel
#' (ie too low of geographic coverage in the region), defaults to TRUE
#' @param check_pixelcount_thresh for a pixelcount check, what proportion of the maximum observed
