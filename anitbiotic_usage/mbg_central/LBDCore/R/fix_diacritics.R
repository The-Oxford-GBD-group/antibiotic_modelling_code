#' @title Fixes diacritic encoding
#' @description Fixes diacritic encoding to UTF-8
#' @param x String or character vector to fix
#' @return String or character vector with replaced diacritics
#' @examples
#' \dontrun{
